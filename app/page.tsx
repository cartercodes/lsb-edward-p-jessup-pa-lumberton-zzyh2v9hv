...
export default function HomePage() {
  ...
  const trustItems = [
    { text: 'Serving Lumberton Families for Over Two Decades', icon: trustIcons[0] },
    { text: 'Trusted by Patients Across Robeson County', icon: trustIcons[1] },
    { text: 'Gentle, Judgment-Free Care for Every Age', icon: trustIcons[2] },
    { text: 'Modern Technology in a Comfortable Setting', icon: trustIcons[3] },
  ];

  const services = [
    { title: 'Family & General Dentistry', desc: 'Comprehensive dental care for every member of your Lumberton family. From routine cleanings to full exams, Edward P Jessup PA keeps your smile healthy at every stage of life.', icon: serviceIcons[0] },
    { title: 'Cosmetic Dentistry', desc: 'Teeth whitening, veneers, and smile makeovers designed to give you confidence. Walk into any room in Robeson County with a smile you\'re proud to show off.', icon: serviceIcons[1] },
    { title: 'Emergency Dental Care', desc: 'Toothaches and dental emergencies don\'t wait, and neither do we. Same-day emergency appointments available for Lumberton patients when you need relief fast.', icon: serviceIcons[2] },
    { title: 'Crowns & Bridges', desc: 'Restore damaged or missing teeth with custom-fitted crowns and bridges that look and feel natural. Durable restorations built to last for years.', icon: serviceIcons[3] },
    { title: 'Pediatric Dentistry', desc: 'Gentle, patient-focused dental care that helps Lumberton kids build healthy habits early. We make every visit positive so your child actually looks forward to the dentist.', icon: serviceIcons[4] },
    { title: 'Preventive & Periodontal Care', desc: 'Deep cleanings, gum disease treatment, and preventive screenings that catch problems before they start. Protecting your oral health is always more affordable than fixing it later.', icon: serviceIcons[5] },
  ];
  ...
  return (
    <>
      ...
      <nav className="nav" role="navigation" aria-label="Main navigation">
        <div className="nav-logo">{'Edward P Jessup PA'}</div>
        <a
          href="tel:19107384465"
          className="nav-cta"
          aria-label="Call Edward P Jessup PA at +1 910-738-4465"
        >
          <span
            dangerouslySetInnerHTML={{ __html: phoneIcon }}
            aria-hidden="true"
          />
          <span>{'+1 910-738-4465'}</span>
        </a>
      </nav>

      {/* HERO */}
      <section className="hero" aria-label="Welcome to Edward P Jessup PA">
        ...
        <div className="hero-content">
          ...
          <p>
            Welcome to {'Edward P Jessup PA'} — where modern dental technology meets compassionate
      ...
      <section className="about" aria-label="About our practice">
        <div className="about-grid">
          ...
          <div className="about-content" data-animate data-delay={2}>
            <h2>About {'Edward P Jessup PA'}</h2>
            <p>{'Edward P Jessup PA has been a cornerstone of dental care in Lumberton, NC, providing the kind of personalized attention that larger practices simply can\'t match. With deep roots in the Robeson County community, this practice combines modern dental techniques with genuine, small-town warmth. Whether you\'re bringing your child in for their first checkup or finally addressing that smile you\'ve been putting off, Edward P Jessup PA delivers care that feels less like a clinical visit and more like being looked after by someone who knows your name.'}</p>
      ...
      <section className="cta-section" aria-label="Contact us">
        <div className="cta-card" data-animate>
          <h2>Contact {'Edward P Jessup PA'}</h2>
          <p>
          ...
          <a
            ...
            aria-label="Call Edward P Jessup PA to schedule an appointment"
          >
            <span
              dangerouslySetInnerHTML={{ __html: phoneIcon }}
              aria-hidden="true"
      ...
      <footer className="footer" role="contentinfo">
        <div className="footer-content">
          <div className="footer-brand">
            <div className="footer-brand-name">{'Edward P Jessup PA'}</div>
            <p>
          ...
          <div className="footer-contact">
            <div className="footer-contact-item">
              ...
              />
              <span>
                {'4300 Ludgate St, Lumberton, NC 28358, USA'}, {'Lumberton'}, {'NC'}
              </span>
            </div>
            <div className="footer-contact-item">
              <span
              ...
              <a
                href="tel:19107384465"
                aria-label="Call Edward P Jessup PA"
        ...
        <div className="footer-bottom">
          &copy; {new Date().getFullYear()} {'Edward P Jessup PA'}. All rights
          reserved.
        </div>
      </footer>
    </>
